...
var Strings = map[string]map[string]string{
	...
	"hi": {
		...
		"post_like_multi": "{{.Name}} and {{.Count}} others loved your post",
		"post_like_three": "{{.Name}}, {{.Name2}} and {{.Name3}} loved your post",
		"post_like_two":   "{{.Name}} and {{.Name2}} loved your post",
		"post_like_one":   "{{.Name}} loved your post",

		"comment_like_multi": "{{.Name}} and {{.Count}} others loved your comment",
		"comment_like_three": "{{.Name}}, {{.Name2}} and {{.Name3}} loved your comment",
		"comment_like_two":   "{{.Name}} and {{.Name2}} loved your comment",
		"comment_like_one":   "{{.Name}} loved your comment",
