...
- मंच परिवार`,
		...
		"manch_10_members_title":     "आपका मंच {{.Community}} Activate हो गया है🔥",
		"manch_10_members_text":      "पोस्ट करें और अपने मंच को ट्रेंडिंग बनाएं 🤩",
...
- Manch టీం`,
		...
		"manch_10_members_title":     "Congratulations, మీ మంచ్ {{.Community}} ఆక్టివేట్ చేయబడింది!!",
		"manch_10_members_text":      "మీ అభిప్రాయాలను  పంచుకొని మీ పోస్ట్ ని ట్రేండింగ్ లో ఉండేలా చూసుకోండి.",
...
var HtmlStrings = map[string]map[string]string{
	...
	"hi": {
		...
		"manch_10_members_title":     "आपका मंच <b>{{.Community}}</b> Activate हो गया है🔥",
		"manch_10_members_text":      "पोस्ट करें और अपने मंच को ट्रेंडिंग बनाएं 🤩",
	...
	"te": {
		...
		"manch_10_members_title":     "Congratulations, మీ మంచ్ <b>{{.Community}}</b> ఆక్టివేట్ చేయబడింది!!",
		"manch_10_members_text":      "మీ అభిప్రాయాలను  పంచుకొని మీ పోస్ట్ ని ట్రేండింగ్ లో ఉండేలా చూసుకోండి.",
