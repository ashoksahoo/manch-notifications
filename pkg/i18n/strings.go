...
- मंच परिवार`,
		"join_manch_request":  "{{.Name}} आपके मंच {{.Community}} से जुड़ना चाहते है 🤩",
		"join_manch_approved": "मुबारक हो अब आप {{.Community}} का हिस्सा हैं 😄",
		"manch_10_members":    "बधाई हो आपके मंच {{.Community}} के 10 सदस्य हो गए हैं🔥",
...
- Manch టీం`,
		...
		"join_manch_request":  "{{.Name}} మీ {{.Community}} మంచ్ లో చేరాలనుకుంటున్నారు. 🤩",
		"join_manch_approved": "{{.Community}} లో చేరడానికి మీ అభ్యర్థన ఆమోదించబడింది. 😄",
		"manch_10_members":    "మీ {{.Community}} 10 సభ్యుల మార్క్ ని చేరుకున్నందుకు అభినందనలు . 🔥",
...
var HtmlStrings = map[string]map[string]string{
	...
	"hi": {
		...
		"join_manch_request":  "<b>{{.Name}}</b> आपके मंच <b>{{.Community}}</b> से जुड़ना चाहते है 🤩",
		"join_manch_approved": "मुबारक हो अब आप <b>{{.Community}}</b> का हिस्सा हैं 😄",
		"manch_10_members":    "बधाई हो आपके मंच <b>{{.Community}}</b> के <b>10</b> सदस्य हो गए हैं🔥",
	...
	"te": {
		...
		"join_manch_request":  "<b>{{.Name}}</b> మీ <b>{{.Community}}</b> మంచ్ లో చేరాలనుకుంటున్నారు. 🤩",
		"join_manch_approved": "<b>{{.Community}}</b> లో చేరడానికి మీ అభ్యర్థన ఆమోదించబడింది. 😄",
		"manch_10_members":    "మీ <b>{{.Community}}</b> <b>10</b> సభ్యుల మార్క్ ని చేరుకున్నందుకు అభినందనలు . 🔥",
