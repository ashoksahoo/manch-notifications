...
var Strings = map[string]map[string]string{
	...
	"te": {
		...
		"tenth_follower_title": "{{.Name}}గారు మీరు {{.Count}} మంది ఫాల్లోవర్స్ ని సంపాదించుకున్నందుకు అభినందనలు !! 🎉",
		"tenth_follower_text_1": "",
		"tenth_follower_text_2": "",
		"tenth_follower_text_3": "",
