...
var Strings = map[string]map[string]string{
	...
	"hi": {
		...
		"welcome_message": "नमस्कार {{.Name}} 🙏🏻,\n\nभारत में बने मंच एप में आपका स्वागत है !\n\n🌟जुड़ें मंच से और कहें अपने मन की बात। आपको सुन रहा है पूरा भारत\n⭐मंच पर आप अलग अलग Interest के ग्रुप से जुड़ सकते हैं। साथ ही पोस्ट, कमेंट और शेयर भी कर सकते हैं।\n🌟आप बना सकते हैं अपना ग्रुप(मंच) और बन सकते हैं Influencer.\n🇮🇳 तो अब बिंदास बोले मंच पर !\nजय हिन्द !\n\n- मंच परिवार",
