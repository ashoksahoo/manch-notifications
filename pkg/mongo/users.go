...
type Profile struct {
	...
	DisplayProfileChanges   bool          `json:"display_profile_changes" bson:"display_profile_changes"`
	DisplayProfileUpdatedAt time.Time     `json:"display_profile_updated_at" bson:"display_profile_updated_at"`
}
